...
本项目基于 [Letta](https://github.com/letta-ai/letta) 开源项目进行开发和增强。我们感谢Letta团队为AI助手开发领域做出的杰出贡献，以及他们提供的强大框架和工具集。

Letta是一个先进的AI助手框架，支持持久记忆、工具使用和多代理协作。本项目在其基础上进行了本土化增强，特别针对国内大模型和使用场景进行了优化。

我们鼓励用户也去了解和支持原始的Letta项目。
